<?php
    ...
    if (isset($_POST['user']) && isset($_POST['pass'])) {
        ...
        if (empty($username) || empty($password)) {
            ...
            $sql = "SELECT * FROM tbl_user WHERE username = '$username' AND password = '$password' AND user_type = 'admin'";
            ...
            if ($result) {
                ...
                if ($count == 1) {
                    ...
                    echo "<script>alert('Username and password are incorrect or do not have admin access.');</script>";
                }
            } else {
